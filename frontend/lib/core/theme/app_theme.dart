...
class AppTheme {
  ...
  /// Subtle, professional cross-page motion. Uses Flutter's built-in
  /// fade-upwards transition (quiet, no bounce) on all platforms — no custom
  /// PageTransitionsBuilder subclass, so it stays compatible across Flutter
  /// versions.
